package com.emretnkl.week5Assignment.data.local.database
...
import com.emretnkl.week5Assignment.data.local.database.converter.DaoConverter
import com.emretnkl.week5Assignment.data.local.database.dao.PostDao
